...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Layer 7 : Convolutional 1x1 (keep shape)
    ...
    # Upsample of conv_1x1_of_7 : deconvolution x 2
    ...
    # Layer 4 : convolutional 1x1 (keep shape)
    ...
    # merge : updsample deconvolution x 2 + Layer 4
    first_skip = tf.add(first_upsamplex2, conv_1x1_of_4, name='first_skip')

    # Upsample dof first skip : econvolutions x 2.
    ...
    # Layer 3 : convolutional 1x1 (keep shape)
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    # create logits : 2D tensor where each row represents (pixel, class).
    logits = tf.reshape(nn_last_layer, (-1, num_classes))  # prediction
    correct_label = tf.reshape(correct_label, (-1, num_classes))  # ground truth
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    print('Starting training...' + str(epochs) + "epochs")
    ...
    for epoch in range(epochs):
        ...
        for image, label in get_batches_fn(batch_size):
            ...
            log_losses.append('{:3f}'.format(loss))
        print(log_losses)
...
def run():
    ...
    with tf.Session() as sess:
        ...
        # Get layers from vgg. (transfer learning)
        ...
        # Start Trainining NN using the train_nn function
        epochs = 20  # 6 12 24 48
        batch_size = 5
